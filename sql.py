...
cursor.execute("""INSERT INTO students (name, email, phone, address, class)
                  VALUES ('Qamar', 'qamar@gmail.com', '0305020345', 'Pakistan', '10th');""")
cursor.execute("""INSERT INTO students (name, email, phone, address, class)
                  VALUES ('Molvi', 'molvi@gmail.com', '03023434545', 'Pakistan', '10th');""")
cursor.execute("""INSERT INTO students (name, email, phone, address, class)
                  VALUES ('Subhan', 'subhan@gmail.com', '03083423543', 'Pakistan', '10th');""")
